  ...
  return (
    ...
    <div className='relative top-8 lg:top-32 m-auto lg:flex w-4/5 lg:w-max font-[kaisei]'>
      ...
      <div className='relative top-0 left-0 flex flex-col  gap-y-2'>
        ...
        <Biobar />
        <p className='font-[ubuntu] italic max-w-2xl'>This will be a 150-word biography.  Right now it is not, however I am adding this text nonetheless so that the paragraph is wide enough to avoid messing up the formatting.</p>
      </div>
    </div>
  </>
  )
