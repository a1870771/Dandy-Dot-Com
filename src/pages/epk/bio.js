  ...
  <>
    ...
    <div className='bg-[#e8e4dd]'>
      ...
      <div className='mx-8 lg:mx-80'>
        <h1 className='pt-12 lg:pt-32 tracking-tighter leading-tight text-4xl font-bold'>50 Words</h1>
